...
export default function Navbar() {
    ...
    return (
        <div className="2xl:flex 2xl:flex-row justify-between items-center w-screen pt-3 pl-6 pr-6 bg-[#101828]">
            <div className="py-4">
            ...
            <div className="flex py-4 flex-row font-bold text-[16px] text-white gap-5">
